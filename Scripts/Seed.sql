...
-- Asegúrate de que las tablas estén vacías y las identidades reseteadas si es necesario antes de ejecutar.
...
-- Códigos actualizados al formato "V-00X"
INSERT INTO sellers (user_id, seller_code) VALUES
(2, 'V-001'), 
(3, 'V-002'), 
(4, 'V-003'), 
(5, 'V-004'); -- Vendedor Inactivo, pero con código en formato
...
-- Productos Vendedor 1 (Carlos Vargas, ID Vendedor: 1, Código: V-001) -> ID Producto: 1-5
...
-- Productos Vendedor 2 (Lucía Fernández, ID Vendedor: 2, Código: V-002) -> ID Producto: 6-10
INSERT INTO products (name, description, price, measurement_unit_id, category_id, stock_quantity, seller_id, is_active) VALUES
...
-- Productos Vendedor 3 (Miguel Suárez, ID Vendedor: 3, Código: V-003) -> ID Producto: 11-15
INSERT INTO products (name, description, price, measurement_unit_id, category_id, stock_quantity, seller_id, is_active) VALUES
