...
namespace GUI
{
    public partial class Frm_MainVendor : Frm_MainBase
    {
        ...
        {
            OpenChildForm(new Frm_DashboardVendor()); // Abre el formulario del Dashboard.
        }
        private void ibtn_Productos_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Frm_GProductsVendor()); // Abre el formulario de Productos.
        }
        private void ibtn_Ventas_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Frm_GSalesVendor()); // Abre el formulario de Ventas.
        }
        private void ibtn_Clientes_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Frm_GClientsVendor()); // Abre el formulario de Clientes.
        }
        private void ibtn_Signout_Click(object sender, EventArgs e) // Evento Click para el botón de Cerrar Sesión.
        {
